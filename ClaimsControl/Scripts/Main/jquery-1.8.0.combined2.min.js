...
window.log = function(str){
  if(this.console){console.log("%c"+str, "color: purple;font-weight:bold;"); }
};
window.log2 = function(str){
  if(this.console){console.log("%c"+str, "color: #2E6B27;font-weight:bold;font-size:14px;"); }
};*/
...
d ? a(d, "length") : 0; this.arrayContentWillChange(b, c, e); if (!d || d.length === 0) this.splice(b, c); else { var f = [b, c].concat(d); this.splice.apply(this, f) } return this.arrayContentDidChange(b, c, e), this
