...
namespace CC.Classes {
   ...
   public class ControlerEdit<T_Rep, T_tbl> : Controller where T_Rep : IRepository_ControlerEdit<T_tbl>, new() {
      ...
      [HttpPost]
      public JsonResult Delete(Int32 id, string DataObject) { return Json(Repository.DeleteRow(id, DataObject)); }

      [HttpPost]
      public JsonResult EditField(string FieldName, Int32 id, string NewValue, string OldValue, string DataObject) { return Json(Repository.UpdateField(FieldName, id, NewValue, OldValue, DataObject)); }

      [HttpPost]
      public JsonResult AddNew(T_tbl Data, string DataObject) { return Json(Repository.AppendRow(Data, DataObject)); }
   }
   ...
   public class ControlerEdit2<T_Rep, T_tbl, T_tbl2> : Controller where T_Rep : IRepository_ControlerEdit2<T_tbl, T_tbl2>, new() {
      ...
      [HttpPost]
      public JsonResult AddNew2(T_tbl2 Data, string DataObject) { return Json(Repository.AppendRow2(Data, DataObject)); }
   }
