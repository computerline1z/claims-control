...
(function() {
  var w=window, $=w.jQuery, App=w.App, Em=w.Em;;  $.widget("ui.UploadFiles", {
    options: {
    ...
    _create: function() {
      ...
      return Em.run.next(this, function() {
        return form.bind('fileuploadadded', function(e, data) {
          ...
          var No, docsContr, docsNo, drv, drvTop, newDoc, opts, refGroupID, topDrivers, topVehicles, veh, vehTop;
