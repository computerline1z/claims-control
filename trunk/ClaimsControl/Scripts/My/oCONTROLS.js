  ...
  w.oCONTROLS = {
      ...
      $(p.frm).find("div.ExtendIt, span.ExtendIt").each(function() {
        ...
        */
        ...
        if (typeof input !== "undefined") {
          ...
          if ((Type === "Integer" || Type === "Decimal") && !plugins.inputControl) {
            input.inputControl({
              type: Type
            });
          }
    ...
    ValidateForm: function(frm, DataToSaveAppend) {
      ...
      $.each(frm.find(".UpdateField:visible"), function(i, v) {
        var CheckIt, Empty, FName, NotEmpty, OldVal, Require, TimeCtrl, Type, UpdateField, Validity, Value, aVal, e, elDesc, val;
    ...
    appendLabel: function(p, t) {
      ...
      if (typeof p.label === "undefined" || p.label === "None") {
        ...
        return "<label class='" + (Top ? "toplabel" : "leftlabel") + (classes ? " " + classes : "") + (p.colLabels.tip ? " js-tip" : "") + "'><span " + (p.classes.span ? "class='" + p.classes.span + "'" : "") + "><span>" + p.label.txt + (Top ? "" : ":") + "</span></span>" + t + "</label>";
      }
    },
    txt: function(p) {
    ...
    radio: function(p) {
      ...
      retStr = "<label" + (p.colLabels.tip ? " class='js-tip'" : "") + ">" + p.colLabels.caption + ":</label>";
