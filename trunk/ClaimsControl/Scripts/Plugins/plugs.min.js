...
(function (a) {
    a.validity.outputs.tooltip = {
        ...
        start: function () {
        	if( a("." + a.validity.outputs.tooltip.tooltipClass).prev().hasClass("validity-error-on-field") ){
        		a("." + a.validity.outputs.tooltip.tooltipClass).prev().removeClass("validity-error-on-field");
        	}
        ...
        raise: function (e, d) {
            ...
            f.top += 8;
            */
            a('<div class="validity-tooltip">' + d + '<div class="validity-tooltip-outer"><div class="validity-tooltip-inner"></div></div></div>').click(function () {
                e.focus();
                a(this).fadeOut();
                if( e.parent().hasClass("validity-error-on-field") ){
                	e.parent().removeClass("validity-error-on-field");
                }
            })/*.css(f)*/.hide().insertAfter(e.parent()).fadeIn();

            e.parent().addClass("validity-error-on-field");
        },
        raiseAggregate: function (a, d) {
...
$.extend($.validity.messages, {
			require: "Šis langelis turi būti užpildytas",  //#{field}
			// Format validators:
			...
			textWithPoint: "Turi būti raidė, skaičius - arba _",
			textOrNumber: "Turi būti raidės arba skaičiai",
			generic: "Neteisinga."
});																	  
...
$.extend($.validity.settings, {
	defaultFieldName: "Šis laukas"  //19|20yy/MM/dd
});