...
(function() {
  var w=window, App=w.App, Em=w.Em, oGLOBAL=w.oGLOBAL, oDATA=w.oDATA, oCONTROLS=w.oCONTROLS, MY=w.MY;  App.listsStart = function() {
    var ctrl;
    ...
    return oDATA.execWhenLoaded(["proc_Vehicles", "proc_Drivers", "proc_InsPolicies"], function() {
      ...
      return ctrl.set("insPolicies", oDATA.GET("proc_InsPolicies").emData);
    });
  };
