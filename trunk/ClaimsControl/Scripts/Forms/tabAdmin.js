...
(function() {
  var w=window, App=w.App, Em=w.Em, oGLOBAL=w.oGLOBAL, oDATA=w.oDATA, oCONTROLS=w.oCONTROLS, MY=w.MY;  App.adminStart = function() {
      ...
      if (DataToSave) {
        opt = {
          ...
          CallBackAfter: (function(Row, Action, resp) {
            return $("#accountName").html(Row.name);
          })
        };
